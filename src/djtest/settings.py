...
AUTHENTICATION_BACKENDS = [
    ...
    # "helloapp.backends.MyAuthBackend",
    # "helloapp.backends.MyLDAPBackend",
...
DATABASE_ROUTERS = (
    "helloapp.dbrouters.ComponentsDBRouter",
    "helloapp.dbrouters.FilesDBRouter",
    "helloapp.dbrouters.ParametersDBRouter",
)


# AUTH_USER_MODEL = 'helloapp.MyUser'
