"""
Django settings for management_web_app project.
...
ROOT_URLCONF = "management_web_app.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [BASE_DIR / "config_management/templates", BASE_DIR / "auth_app/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "management_web_app.wsgi.application"
...
DATABASE_ROUTERS = (
    "config_management.dbrouters.ComponentsDBRouter",
    "config_management.dbrouters.FilesDBRouter",
    "config_management.dbrouters.ParametersDBRouter",
)
