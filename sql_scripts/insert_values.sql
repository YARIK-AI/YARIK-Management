...
INSERT INTO artifacts.parameters (id,"name",description,absxpath,value,input_type,file_id) VALUES
	 (1,'Container port','Number of port to expose on the pods IP address. This must be a valid port number, 0 < x < 65536.','/postgres/spec/template/spec/containers/ports/containerPort','5432','number',1),
	 (2,'Number of replicas','This is the number of desired replicas. This is a pointer to distinguish between explicit zero and unspecified','/postgres/spec/replicas','5','number',1),
	 (16,'Custom','Custom parameters in json format.','/postgres/custom','{"m": "10", "reg": "\"ffg\""}','text',1),
	 (17,'Init container image name','Image name in repository/name:version format','/superset/spec/template/spec/initContainers/image','aggrik/superset:2.1.0','text',3),
	 (18,'Container image name','Image name in repository/name:version format','/superset/spec/template/spec/containers/image','aggrik/superset:2.1.0','text',3),
	 (19,'Container image name','Image name in repository/name:version format','/redis/spec/template/spec/containers/image','aggrik/redis:latest','text',4),
	 (20,'Init container image name','Image name in repository/name:version format','/postgres/spec/template/spec/initContainers/image','aggrik/postgresql:latest','text',5),
	 (21,'Container image name','Image name in repository/name:version format','/postgres/spec/template/spec/containers/image','aggrik/postgresql:latest','text',5),
	 (12,'Readonly flag for 2 volume mount','Mounted read-only if true, read-write otherwise.','/ubuntu/spec/template/spec/containers/volumeMounts[@n="2"]/readOnly','true','checkbox',6),
	 (13,'Target port','Number or name of the port to access on the pods targeted by the service. Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME.','/postgres/spec/ports/targetPort','5432','number',2),
	 (14,'Node port','The port on each node on which this service is exposed when type is NodePort or LoadBalancer.','/postgres/spec/ports/nodePort','32321','number',2),
	 (15,'Port','The port that will be exposed by this service.','/postgres/spec/ports/port','3239','number',2),
	 (3,'Required memory','Describes the minimum amount of ram required','/ubuntu/spec/template/spec/containers/resources/requests/memory','2Gi','text',6),
	 (4,'Required cpu','Describes the minimum amount of cpu required','/ubuntu/spec/template/spec/containers/resources/requests/cpu','2','number',6),
	 (5,'Max memory','Describes the maximum amount of ram resources allowed','/ubuntu/spec/template/spec/containers/resources/limits/memory','2Gi','text',6),
	 (6,'Max cpu','Describes the maximum amount of cpu resources allowed','/ubuntu/spec/template/spec/containers/resources/limits/cpu','2','number',6),
	 (7,'Mount path for 1 volume','Path within the container at which the volume should be mounted. Must not contain ":".','/ubuntu/spec/template/spec/containers/volumeMounts[@n="1"]/mountPath','/home/sdl/workspace','text',6),
	 (8,'Name of 1 volume','This must match the Name of a Volume.','/ubuntu/spec/template/spec/containers/volumeMounts[@n="1"]/name','ubuntu-data','text',6),
	 (9,'Readonly flag for 1 volume mount','Mounted read-only if true, read-write otherwise.','/ubuntu/spec/template/spec/containers/volumeMounts[@n="1"]/readOnly','true','checkbox',6),
	 (10,'Mount path for 2 volume','Path within the container at which the volume should be mounted. Must not contain ":".','/ubuntu/spec/template/spec/containers/volumeMounts[@n="2"]/mountPath','/home/sdl/weg','text',6),
	 (11,'Name of 2 volume','This must match the Name of a Volume.','/ubuntu/spec/template/spec/containers/volumeMounts[@n="2"]/name','ubuntu-weg','text',6);